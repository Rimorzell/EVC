...
from evc_white_balance import evc_white_balance  # noqa: E402
...
def gui_white_balance(img: np.ndarray) -> np.ndarray:
...
class ApplicationWindow(QtWidgets.QMainWindow):
    ...
    def reset_white(self):
        ...
        self.img_balanced = evc_white_balance(self.img, np.array([1, 1, 1]))
        self.refresh_balanced_img()
